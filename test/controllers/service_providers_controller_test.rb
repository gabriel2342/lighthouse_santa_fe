...
class ServiceProvidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create service_provider" do
    assert_difference("ServiceProvider.count") do
      post service_providers_url, params: { service_provider: { about: @service_provider.about, city: @service_provider.city, contact_person: @service_provider.contact_person, email: @service_provider.email, municipality_id: @service_provider.municipality_id, name: @service_provider.name, phone: @service_provider.phone, services: @service_provider.services, state: @service_provider.state, street: @service_provider.street, url: @service_provider.url, zip: @service_provider.zip } }
    end
  ...
  test "should update service_provider" do
    patch service_provider_url(@service_provider), params: { service_provider: { about: @service_provider.about, city: @service_provider.city, contact_person: @service_provider.contact_person, email: @service_provider.email, municipality_id: @service_provider.municipality_id, name: @service_provider.name, phone: @service_provider.phone, services: @service_provider.services, state: @service_provider.state, street: @service_provider.street, url: @service_provider.url, zip: @service_provider.zip } }
