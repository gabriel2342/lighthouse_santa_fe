...
class MunicipalitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create municipality" do
    assert_difference("Municipality.count") do
      post municipalities_url, params: { municipality: { name: @municipality.name, organization_id: @municipality.organization_id } }
    end
  ...
  test "should update municipality" do
    patch municipality_url(@municipality), params: { municipality: { name: @municipality.name, organization_id: @municipality.organization_id } }
